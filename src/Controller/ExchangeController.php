...
public function acceptRequest(int $id, ExchangeRepository $exchangeRepository, BooksRepository $booksRepository, Request $request, EntityManagerInterface $entityManager): Response
{
    ...
    $exchangeRequest->setBookTwo($bookTwo); // Livre choisi par le destinataire
    $exchangeRequest->setAcceptedAt(new \DateTimeImmutable()); // Date d'acceptation
    $exchangeRequest->setStatus(ExchangeEnum::VALIDATED); // Statut mis à jour
